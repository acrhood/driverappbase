...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-signup-signup-module"], {
  ...
  /***/
  function node_modulesBrMask__ivy_ngcc__DistAppModuleJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesBrMask__ivy_ngcc__DistDirectivesBrMaskJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesBrMask__ivy_ngcc__DistDirectivesIndexJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesBrMask__ivy_ngcc__DistIndexJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppPagesSignupSignupPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SignupPage = /*#__PURE__*/function () {
      function SignupPage(loadingCtrl, navCtrl, authService, afAuth, crudService) {
                  ...
                  case 9:
                    if (valCreateUSer == false) {
                      ...
                      this.authService.signUpWithEmail(this.email.replace(/\s+/g, ''), this.pass + '$').then(function (res) {
                        console.log(res);
                        loading.dismiss();
                        _this.phone = _this.phone == undefined ? '' : _this.phone;
                        _this.cedula = _this.cedula == undefined ? 0 : _this.cedula;
                        _this.userid = res.user.uid;
                        var data = {
                          sel: '',
                          tbl: 6,
                          where: '1,0,"' + _this.name + '","' + _this.email + '","' + _this.pass + '$",' + impresa + ',"' + _this.phone + '","' + _this.userid + '",' + _this.cedula + ',3,0'
                        };

                        _this.crudService.crud(data).subscribe(function (result) {
                          console.log('result database');
                          console.log(result);

                          _this.afAuth.currentUser.then(function (user) {
                            user.updateProfile({
                              ...
                              if (res.additionalUserInfo.isNewUser == true) {
                                ...
                                _this.navCtrl.navigateBack('/sessionstatus');
                              }
                              ...
                              switch (_context.prev = _context.next) {
                                case 0:
                                  ...
                                  if (error.code == 'auth/invalid-email') {
                                    loading.dismiss();
                                    console.log('Correo inválido'); // this.general.mostrar_error('Correo inválido');
                                  } else if (error.code == 'auth/weak-password') {
                                    loading.dismiss();
                                    console.log('Contraseña inválida'); // this.general.mostrar_error('Contraseña inválida');
                                  } else if (error.code == 'auth/email-already-in-use') {
                                    loading.dismiss();
                                    console.log('Este usuario ya ha sido registrado'); // this.general.mostrar_error('Este usuario ya ha sido registrado');
                                  } else {
                      ...
                      loading.dismiss();
                      console.log(String(valCreateUSer)); // this.general.mostrar_error(String(valCreateUSer));
                    }
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('xname', {
      "static": false
    })], SignupPage.prototype, "xname", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('xemail', {
      "static": false
    })], SignupPage.prototype, "xemail", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('xpass', {
      "static": false
    })], SignupPage.prototype, "xpass", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('xphone', {
      "static": false
    })], SignupPage.prototype, "xphone", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('xcedula', {
      "static": false
    ...
    var CrudService = /*#__PURE__*/function () {
      ...
      _createClass(CrudService, [{
        ...
        value: function crud(data) {
          return this.http.get("".concat(URL, "conf_app/ctr_app.php?arreglo=") + JSON.stringify(data));
        }
      }]);
